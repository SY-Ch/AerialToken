# Single-domain evaluation: Table I / II, FloodNet.
#
...
val_dataloader = dict(dataset=dict(datasets=[{{_base_.floodnet_val_dataloader}}]))
test_dataloader = val_dataloader

val_evaluator = dict(dataset_keys=["FloodNet"], mean_used_keys=["FloodNet"])

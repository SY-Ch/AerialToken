# Single-domain evaluation: Table I / II, OpenEarthMap.
#
...
val_dataloader = dict(dataset=dict(datasets=[{{_base_.oem_val_dataloader}}]))
test_dataloader = val_dataloader

val_evaluator = dict(dataset_keys=["OEM"], mean_used_keys=["OEM"])

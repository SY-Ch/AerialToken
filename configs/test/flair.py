# Single-domain evaluation: Table I / II, FLAIR.
#
...
val_dataloader = dict(dataset=dict(datasets=[{{_base_.flair_val_dataloader}}]))
test_dataloader = val_dataloader

val_evaluator = dict(dataset_keys=["FLAIR"], mean_used_keys=["FLAIR"])

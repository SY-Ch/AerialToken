# Single-domain evaluation: Table III / IV, UAVid.
#
...
val_dataloader = dict(dataset=dict(datasets=[{{_base_.uavid7_val_dataloader}}]))
test_dataloader = val_dataloader

val_evaluator = dict(dataset_keys=["Uavid7"], mean_used_keys=["Uavid7"])

# Single-domain evaluation: Table III / IV, UDD7.
#
...
val_dataloader = dict(dataset=dict(datasets=[{{_base_.udd7_val_dataloader}}]))
test_dataloader = val_dataloader

val_evaluator = dict(dataset_keys=["UDD7"], mean_used_keys=["UDD7"])
